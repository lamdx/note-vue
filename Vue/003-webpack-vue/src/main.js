...
// 4. 在 package.json 文件中，查找 一个 main 属性【main属性指定了这个包在被加载时候
// 的入口文件】
...
// 2. 由于 在 webpack 中，推荐使用 .vue 这个组件模板文件定义组件，所以，
// 需要安装 能解析这种文件的 loader  npm i vue-loader vue-template-complier -D
